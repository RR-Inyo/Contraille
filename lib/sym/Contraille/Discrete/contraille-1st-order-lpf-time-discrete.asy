...
SYMATTR SpiceModel first-order-lpf-time-discrete
SYMATTR Description Tustin transform of a first-order low-pass filter (LPF) or first-order delay, T-specified
PIN 64 0 NONE 8
PINATTR PinName y
